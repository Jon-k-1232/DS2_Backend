...
-- removed: timesheet_errors (deprecated)
...
ALTER TABLE account_automation_recipients
     ADD CONSTRAINT account_automation_recipients_unique_account_automation_user UNIQUE (account_id, automation_key, user_id);
